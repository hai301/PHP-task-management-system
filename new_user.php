				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group d-flex justify-content-center align-items-center">
							<img src="<?php echo isset($avatar) ? 'assets/uploads/'.$avatar :'./assets/uploads/1606958760_avatar.jpg' ?>" alt="Avatar" id="cimg" class="img-fluid img-thumbnail ">
						</div>
					</div>
					<div class="col-md-6">
...
<script>
	...
	$('#manage_user').submit(function(e){
		...
		if($('[name="password"]').val().length < 8) {
           alert("Password must me longer than 8 characters!")
		   return
		} 
